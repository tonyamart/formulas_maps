...
## Directions Analysis & Plots

The notebook assigns each formula to a compass segment (e.g., N, NE, E,
etc.), and calculates the proportion of formulas in each segment. The
resulting visualisations highlight the prevalent directional patterns in
each corpus.

-   Angle Calculation: Assigns each formula to a corpus segment, such as
    North, South, etc.

-   Figures: Generates Figure 3b and 4b.
...
![](03_directions_plots.markdown_strict_files/figure-markdown_strict/unnamed-chunk-9-1.png)

# Fig. 4b

Short distances

![](03_directions_plots.markdown_strict_files/figure-markdown_strict/unnamed-chunk-10-1.png)
