...
The notebook assigns each formula to a compass segment (e.g., N, NE, E, etc.), and calculates the proportion of formulas in each segment. The resulting visualisations highlight the prevalent directional patterns in each corpus.

-   Angle Calculation: Assigns each formula to a corpus segment, such as North, South, etc.
